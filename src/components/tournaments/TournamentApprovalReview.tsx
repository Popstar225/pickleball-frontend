/**
 * State Tournament Creation Form Component
 */
...
const inputDisabledCls = cn(
  'h-10 rounded-xl text-sm px-3',
  'bg-white/[0.02] border-white/[0.06] text-white/35 cursor-not-allowed',
);
const textareaCls = cn(
  ...
  'focus:outline-none focus:border-[#ace600]/50 focus:bg-[#ace600]/[0.03] transition-all',
);
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export const StateTournamentCreationForm: React.FC<Props> = ({
  stateCode,
  onSuccess,
  onCancel,
}) => {
  ...
  const onSubmit = (data: TournamentFormData) => {
    dispatch(createTournamentWithSetup({ ...data, tournament_type: 'state' }));
  };
    ...
    <div className="w-full max-w-3xl mx-auto space-y-5">
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full border text-[10px] font-bold uppercase tracking-wider bg-sky-500/10 border-sky-500/20 text-sky-400">
            <span className="w-1.5 h-1.5 rounded-full bg-sky-400" />
            Estatal{stateCode ? ` · ${stateCode}` : ''}
          </span>
        </div>
        <p className="text-xs text-white/25">
          Una vez creado, el torneo será enviado a validación de la federación
        </p>
      </div>
        ...
        <div className="bg-[#0d1117] border border-white/[0.07] rounded-2xl p-5 sm:p-6">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej. Campeonato Estatal 2025"
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej. Complejo Deportivo Estatal"
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {stateCode ? (
                    /* State is locked when stateCode prop is provided */
                    ...
                    <Input
                      ...
                      placeholder="Clave de estado (ej. JAL)"
                    />
                  )}
              ...
              {/* Federation validation notice */}
              <div className="flex items-start gap-3 p-3.5 bg-sky-500/[0.05] border border-sky-500/12 rounded-xl">
                <Trophy className="w-4 h-4 text-sky-400/70 shrink-0 mt-0.5" />
                <p className="text-xs text-sky-400/60 leading-relaxed">
                  Este torneo estatal requerirá aprobación de la federación antes de ser publicado.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    className={inputCls}
                    type="email"
                    placeholder="contacto@estado.org"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Detalles sobre tu torneo estatal…"
          ...
          {step === 'technical' && (
            <div className="space-y-5">
              ...
              <p className="text-xs text-white/30 leading-relaxed -mt-2">
                Elige las categorías, géneros y modalidades para tu torneo estatal.
              </p>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-1.5 mt-1.5">
                              {[event.block, event.gender].map((tag) => (
                                <span
                                  key={tag}
                                  className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-white/[0.05] border border-white/[0.08] text-white/30"
                                >
                                  {tag}
                                </span>
                              ))}
              ...
              {selectedEvents.length > 0 && (
                <div className="flex items-center gap-2 pt-1">
                  <div className="w-5 h-5 rounded-full bg-[#ace600] flex items-center justify-center">
                  ...
                  [
                    {
                      ...
                      icon: Layers,
                      desc: 'Fase de grupos seguida de eliminación directa. Recomendado para torneos estatales con muchos participantes.',
                    },
                    {
                ...
                <div className="flex items-start gap-3 p-4 bg-white/[0.03] border border-white/[0.06] rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/30 leading-relaxed">
                      Tamaños disponibles: potencias de 2 (8, 16, 32, 64…). El bracket se genera
                      automáticamente al inicio del torneo.
                    </p>
                  </div>
                </div>
              )}
          ...
          {step === 'review' && (
            <div className="space-y-5">
              ...
              {/* Federation validation notice */}
              <div className="flex items-start gap-3 p-3.5 bg-sky-500/[0.05] border border-sky-500/15 rounded-xl">
                <Trophy className="w-4 h-4 text-sky-400 shrink-0 mt-0.5" />
                <div>
                  <p className="text-xs font-semibold text-sky-400 mb-0.5">
                    Pendiente de validación
                  </p>
                  <p className="text-xs text-sky-400/60 leading-relaxed">
                    Al crear este torneo estatal quedará en estado{' '}
                    <strong>Pendiente de Aprobación</strong>. La federación lo revisará antes de
                    publicarlo.
                  </p>
                </div>
              </div>
              ...
              {[
                ...
                },
                {
                  ...
                  rows: [
                    ...
                    {
                      label: 'Eventos',
                      value: `${selectedEvents.length} categoría${selectedEvents.length !== 1 ? 's' : ''}`,
                    },
                    {
                      label: 'Cuota',
...
export default StateTournamentCreationForm;
