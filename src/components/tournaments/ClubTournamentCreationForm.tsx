...
export const ClubTournamentCreationForm: React.FC<Props> = ({ onSuccess, onCancel }) => {
  ...
  const onSubmit = (data: TournamentFormData) => {
    dispatch(createTournamentWithSetup({ ...data, tournament_type: 'club', judges, coach }));
  };

  console.log('Selected events:', validEvents);
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addCoach())}
                />
                <Button
                  type="button"
                  onClick={addCoach}
