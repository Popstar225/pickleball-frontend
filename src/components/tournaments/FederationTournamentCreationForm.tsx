/**
 * Federation Tournament Creation Form Component
 */
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export const FederationTournamentCreationForm: React.FC<Props> = ({ onSuccess, onCancel }) => {
  ...
  const onSubmit = (data: TournamentFormData) => {
    dispatch(createTournamentWithSetup({ ...data, tournament_type: 'admin', judges, coach }));
  };
    ...
    <div className="w-full max-w-3xl mx-auto space-y-5">
      ...
      <div>
        ...
        <p className="text-xs text-white/25">
          El torneo será publicado automáticamente y disponible para registro
        </p>
      </div>
        ...
        <div className="bg-[#0d1117] border border-white/[0.07] rounded-2xl p-5 sm:p-6">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ej. Arena Deportiva Nacional"
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Detalles sobre este torneo nacional…"
          ...
          {step === 'technical' && (
            <div className="space-y-5">
              ...
              <p className="text-xs text-white/30 leading-relaxed -mt-2">
                Elige las categorías, géneros y modalidades para tu torneo nacional.
              </p>
                  ...
                  [
                    {
                      ...
                      icon: Layers,
                      desc: 'Fase de grupos seguida de eliminación directa. Recomendado para torneos nacionales con muchos participantes.',
                    },
                    {
          ...
          {step === 'review' && (
            <div className="space-y-5">
              ...
              {/* Auto-publish notice */}
              <div className="flex items-start gap-3 p-3.5 bg-[#ace600]/[0.05] border border-[#ace600]/15 rounded-xl">
                <Zap className="w-4 h-4 text-[#ace600] shrink-0 mt-0.5" />
                <div>
                  <p className="text-xs font-semibold text-[#ace600] mb-0.5">
                    Publicación automática
                  </p>
                  <p className="text-xs text-[#ace600]/60 leading-relaxed">
                    Este torneo nacional será publicado automáticamente y disponible para registro
                    inmediatamente tras su creación.
                  </p>
                </div>
              </div>
            ...
            <>
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Trophy className="w-4 h-4" /> Crear y Publicar
                  </>
                )}
              </button>
            </>
