...
const TYPE_CONFIG: Record<string, { label: string; color: string }> = {
  ...
  state: { label: 'Estado', color: 'text-sky-400 bg-sky-500/[0.08] border-sky-500/20' },
        ...
        <div className="px-6 pt-5 pb-5 border-b border-white/[0.06]">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            ...
            {t.registration_deadline && (
              <MetaPill icon={Clock}>Cierre de reg. {formatDate(t.registration_deadline)}</MetaPill>
            )}
          ...
          <div className="px-6 py-5 space-y-5">
            ...
            <Section icon={Users} title="Participantes">
              ...
              <p className="text-[11px] text-white/25 mt-1.5">
                {Math.round(fillPct)}% de capacidad ocupada
              </p>
            </Section>
