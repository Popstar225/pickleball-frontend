          ...
          <div className="space-y-4">
            <div className="p-4 bg-primary/10 border border-primary/30 rounded-xl">
              <p className="font-semibold text-white">
                {t('pages.playerSearchMap.paymentModal.paymentLabel', { price: FEATURE_PRICE })}
              </p>
          ...
          <div className="space-y-6">
            <div className="text-center p-6 bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/30 rounded-xl">
              ...
              <p className="text-sm text-primary font-semibold">
                {t('pages.playerSearchMap.paymentModal.priceSub')}
              </p>
            </div>
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">
            {t('pages.playerSearchMap.loginGate.title')}
          </h2>
      ...
      <>
        <div className="min-h-screen flex flex-col bg-slate-950 items-center justify-center p-6">
          <div className="max-w-md w-full text-center space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-2">
                {t('pages.playerSearchMap.lockedScreen.title')}
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded-full px-5 py-2">
                  ...
                  <span className="text-sm text-primary font-semibold">
                    {t('pages.playerSearchMap.playersFound', { count: players.length })}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row flex-1" style={{ minHeight: '650px' }}>
            ...
            <div className="p-4 border-b border-slate-700/50 bg-slate-900/80 backdrop-blur-sm">
              ...
              <div className="relative mb-3">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 h-10 bg-slate-800 border border-slate-600 text-white text-sm rounded-lg placeholder:text-slate-400 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                />
              </div>

              {/* Radius + skill filters */}
            ...
            <div ref={playerListRef} className="flex-1 overflow-y-auto p-3 space-y-2">
              {loading && (
                <div className="flex flex-col items-center justify-center py-16 gap-3">
                  ...
                  <p className="text-slate-400 text-sm">{t('pages.playerSearchMap.searching')}</p>
                </div>
              )}
              ...
              {!loading && !error && filteredPlayers.length === 0 && (
                <div className="flex flex-col items-center justify-center py-16 gap-3">
                  ...
                  <p className="text-slate-400 text-sm text-center">{t('pages.playerSearch.no_results')}</p>
                </div>
              )}
          ...
          >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                          <div
                            style={{
                              ...
                              fontWeight: 700, fontSize: '16px', color,
                            }}
                          >
                            {(player.full_name || '?').charAt(0).toUpperCase()}
                          </div>
            ...
            <div className="absolute top-4 right-4 z-[1000] bg-slate-900/90 backdrop-blur-sm border border-slate-700/50 rounded-xl p-3 flex items-center gap-2 pointer-events-none">
              ...
              <span className="text-slate-400 text-xs">{t('pages.playerSearchMap.nearby')}</span>
            </div>
          </div>
        </div>
      </main>
