/**
 * State Tournament Dashboard — full management for state delegates
 */
  ...
  useEffect(() => {
    if (tournamentId && selectedEvent?.id) {
      ...
      dispatch(fetchEventMatches({ tournamentId, eventId: selectedEvent.id } as any))
        .then(() => console.log('[State] ✓ Matches loaded'))
        .catch((err: any) => console.error('[State] ✗ Failed to load matches:', err));

      dispatch(fetchEventRegistrations({ tournamentId, eventId: selectedEvent.id } as any))
        .then(() => console.log('[State] ✓ Registrations loaded'))
        .catch((err: any) => console.error('[State] ✗ Failed to load registrations:', err));
    }
