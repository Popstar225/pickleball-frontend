...
import { AlertCircle, Check, X, Loader2, ChevronDown, Filter, RefreshCw } from 'lucide-react';
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-xs text-white/30">Cargando torneos…</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-white/30">
            Aprueba o rechaza torneos creados por clubes en tu estado
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Pendientes', value: tournaments.length, color: 'text-amber-400' },
          {
            label: 'Tu Estado',
            value: user?.state || '—',
            color: 'text-white/40',
      ...
      {tournaments.length === 0 ? (
        <div className="bg-[#0d1117] border border-white/[0.07] rounded-2xl p-8 text-center">
          ...
          <p className="text-sm font-semibold text-white/40 mb-1">¡Todos los torneos validados!</p>
      ...
      <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
        <DialogContent className="bg-[#161c25] border border-white/[0.08] rounded-2xl sm:rounded-3xl max-w-md">
          <DialogHeader>
            <DialogTitle className="text-white">Rechazar Torneo</DialogTitle>
          ...
          <div className="space-y-4 py-4">
            <div className="flex items-start gap-3 p-3 bg-red-500/[0.06] border border-red-500/15 rounded-xl">
              ...
              <p className="text-xs text-red-400/80 leading-relaxed">
                Proporciona una razón clara para el rechazo. El club podrá apelar o hacer cambios.
              </p>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Explica por qué rechazas este torneo…"
