/**
 * Federation Schedule Overview Page
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export default function FederationScheduleOverviewPage() {
    ...
    const load = async () => {
      try {
        ...
        const url = organizerId
          ...
          : '/tournaments?tournament_type=national&limit=50';
              ...
              <div className="divide-y divide-white/[0.04]">
                {(tournament.events ?? []).map((ev, idx) => (
                  <div key={ev.id}
                    ...
                    <button
                      onClick={() =>
                        navigate(`/admin/dashboard/tournaments/${tournament.id}/events/${ev.id}/schedule`)
                      }
